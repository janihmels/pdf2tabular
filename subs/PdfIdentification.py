...
def CheckPdf(pdf_text, fullfile):
    if ord(pdf_text[0]) == 12 or ord(pdf_text[0]) == 32:  ############################# Specific cases pay attention!!!!!
        pdf_text = pdf_To_text(fullfile, pages=[2])
    ...
    # ------------------- CMG -------------------
    formatdict["roystmt.cmgsecure.com"] = "CMG"
    # ------------------- CMG -------------------

    # ------------------- PRS -------------------
    formatdict["www.prsformusic.com/estatements"] = "PRS"
    # ------------------- PRS -------------------
