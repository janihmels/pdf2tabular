...
def incomeIIxrevxhalf(database, df, filename):
...
#Build sheet
  ...
  #Worksheet title
  ws.title = "Income Type II x Rev x {}".format(period_name)
  ...
  select_table_1_3 = '''sum( CASE WHEN Statement_Period_Half_9LC >= "{}" THEN Adjusted_Royalty_SB ELSE "" END) 
                   ...
                   GROUP BY Normalized_Income_Type_II_9LC ORDER BY `Total` DESC'''.format(cut_off)
...
#incomeIIxrevxhalf('The Chainsmokers - Hipgnosis - Final_61df0d95f5592bbb47ad9a87')
