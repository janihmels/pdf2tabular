...
def songgeniusID(database, df, filename):
...
#Find number of songs
  find_songs = '''SELECT Song_Name_9LC, Genius_ID_9LC
                  FROM Master GROUP BY Song_Name_9LC, Genius_ID_9LC '''
...
#Build sheet
  ...
  #Worksheet title
  ws.title = "Song,Genius ID"

  #Build table
  select_table_1_1 = '''SELECT Song_Name_9LC, Genius_ID_9LC,'''
  select_table_1_2 = ""
  ...
  select_table_1_3 = '''sum( CASE WHEN Song_Name_9LC <> "Pool Revenue" AND {} >= "{}"
                   ...
                   GROUP BY Song_Name_9LC, Genius_ID_9LC ORDER BY `Total` DESC'''.format(cut_off_field, cut_off)
  ...
  pool_rev_1_1 = '''SELECT Song_Name_9LC, Genius_ID_9LC, '''
  pool_rev_1_2 = ""
  ...
  column_names_1 = ['Song Title','Genius ID']
