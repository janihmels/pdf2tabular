...
def incomecountrysongshare(database, df, filename):
...
#Build main pivot table
  ...
  #Build table
  select_table_1 = '''SELECT Song_Name_9LC, Country_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                      AND Statement_Period_Half_9LC <> "" GROUP BY Song_Name_9LC, Country_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB'''
  ...
  pool_rev_1 = '''SELECT Song_Name_9LC, Country_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC,Payee_Song_Share_SB FROM Master WHERE Song_Name_9LC = "Pool Revenue"
                      AND Statement_Period_Half_9LC <> "" GROUP BY Song_Name_9LC, Country_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB'''
  ...
  column_names_1 = ['Song Name','Country', 'Normalized Income Type', 'Normalized Income Type II',  'Song Share']
