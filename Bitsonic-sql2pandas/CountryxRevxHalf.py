...
def countryxrevxhalf(database, df, filename):
...
#Build sheet
  ...
  #Worksheet title
  ws.title = "Country x Rev x {}".format(period_name)

  #Build table
  select_table_1_1 = '''SELECT Country_SB,'''
  select_table_1_2 = ""
  ...
  select_table_1_3 = '''sum( CASE WHEN Statement_Period_Half_9LC >= "{}"
                   ...
                   GROUP BY Country_SB ORDER BY `Total` DESC'''.format(cut_off)
...
#countryxrevxhalf('The Chainsmokers - Hipgnosis - Final_61df0d95f5592bbb47ad9a87')
