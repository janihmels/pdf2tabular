...
def songIDincomepayeepercent(database, df, filename):
...
#Find number of songs
  find_songs = '''SELECT Song_Name_9LC, Payer_Song_ID_SB,Normalized_Income_Type_II_9LC, Income_Type_SB, Payee_Percent_Received_SB
                  FROM Master WHERE Statement_Period_Half_9LC <> "" GROUP BY Song_Name_9LC, Payer_Song_ID_SB,Normalized_Income_Type_II_9LC, Income_Type_SB,Payee_Percent_Received_SB'''
...
#Build sheet
  ...
  #Worksheet title
  ws.title = "Song,ID,Income Type,Payee %"

  #Build table
  select_table_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB,  Normalized_Income_Type_II_9LC, Income_Type_SB, Payee_Percent_Received_SB FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                      AND Statement_Period_Half_9LC <> "" GROUP BY Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_II_9LC, Income_Type_SB, Payee_Percent_Received_SB'''
  ...
  pool_rev_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_II_9LC, Income_Type_SB, Payee_Percent_Received_SB FROM Master WHERE Song_Name_9LC = "Pool Revenue"
                      AND Statement_Period_Half_9LC <> "" GROUP BY Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_II_9LC, Income_Type_SB, Payee_Percent_Received_SB'''
  ...
  column_names_1 = ['Song Title', 'Payer ID', 'Normalized Income Type II', 'Income Type', 'Payee Percent Received']
