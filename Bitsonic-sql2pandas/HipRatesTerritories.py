...
def hipratesterritories(database, df, filename):
...
#Create sheets
  ws = wb.active
  ws.title = 'Country,Income,Payee %,Rev'
  ws_1 = wb.create_sheet(title='Block,Income,Payee %,Rev')
  ws_2 = wb.create_sheet(title='Block,Region,Country,Income,Payee %,Rev')
  ws_3 = wb.create_sheet(title='Country,Income,Song Share,Rev')
  ws_4 = wb.create_sheet(title='Block,Income,Song Share,Rev')
  ws_5 = wb.create_sheet(title='Block,Region,Country,Song Share,Rev')

#Sheet 1: Country,Income,Payee %,Rev
  #Find number of songs
  find_songs = '''SELECT Song_Name_9LC, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB
                  FROM Master GROUP BY Song_Name_9LC, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB'''
  mycursor.execute(find_songs)
  songs = [i[0] for i in mycursor.fetchall()]
  song_count = len(songs)

  #Build table
  select_table_1 = '''SELECT Song_Name_9LC, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB,  
                      sum( CASE WHEN {} >= "{}" THEN Adjusted_Royalty_SB ELSE "" END) AS `Total` FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                      GROUP BY Song_Name_9LC, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB'''.format(cut_off_field,cut_off)
  mycursor.execute(select_table_1)
  table_1 = mycursor.fetchall()

  #Add pool revenue line at bottom
  pool_rev_1 = '''SELECT Song_Name_9LC, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB,  
                      sum( CASE WHEN {} >= "{}" THEN Adjusted_Royalty_SB ELSE "" END) AS `Total` FROM Master WHERE Song_Name_9LC = "Pool Revenue"
                      GROUP BY Song_Name_9LC, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB'''.format(cut_off_field,cut_off)
  ...
  column_names_1 = ['Song Title', 'Country','Normalized Income Type',  'Normalized Income Type II', 'Payee Percent Received', 'Total Revenue']
  ...
  ws.cell(row=song_count+2, column=1).style = 'title_style'
  ws.cell(row=song_count+2, column=len(column_names_1)).value = '=SUM({}2:{}{})'.format(column_letters[len(column_names_1)-1],column_letters[len(column_names_1)-1],song_count+1)
  ws.cell(row=song_count+2, column=len(column_names_1)).style = 'total_style'

#Sheet 2: Block,Income,Payee %,Rev
  #Find number of songs
  find_songs = '''SELECT Song_Name_9LC, Regional_Block_DD, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB
                    FROM Master GROUP BY Song_Name_9LC, Regional_Block_DD, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB'''
  mycursor.execute(find_songs)
  songs = [i[0] for i in mycursor.fetchall()]
  song_count = len(songs)

  #Build table
  select_table_1 = '''SELECT Song_Name_9LC, Regional_Block_DD, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB,  
                        sum( CASE WHEN {} >= "{}" THEN Adjusted_Royalty_SB ELSE "" END) AS `Total` FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                        GROUP BY Song_Name_9LC, Regional_Block_DD, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB'''.format(
    cut_off_field, cut_off)
  mycursor.execute(select_table_1)
  table_1 = mycursor.fetchall()

  #Add pool revenue line at bottom
  pool_rev_1 = '''SELECT Song_Name_9LC, Regional_Block_DD, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB,  
                        sum( CASE WHEN {} >= "{}" THEN Adjusted_Royalty_SB ELSE "" END) AS `Total` FROM Master WHERE Song_Name_9LC = "Pool Revenue"
                        GROUP BY Song_Name_9LC, Regional_Block_DD, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB'''.format(
    cut_off_field, cut_off)
  mycursor.execute(pool_rev_1)
  ...
  #Create list of column names
  column_names_1 = ['Song Title', 'Regional Block', 'Normalized Income Type', 'Normalized Income Type II',
                    'Payee Percent Received', 'Total Revenue']
  ...
  for song_no in range(2, song_count + 2):
    ...
    ws_1.cell(row=song_no, column=2).alignment = Alignment(horizontal="left", vertical="center")
    ws_1.cell(row=song_no, column=3).alignment = Alignment(horizontal="left", vertical="center")
    ws_1.cell(row=song_no, column=4).alignment = Alignment(horizontal="left", vertical="center")
    ws_1.cell(row=song_no, column=(len(column_names_1))).number_format = '#0.00'

  #Add total row
  ws_1.cell(row=song_count + 2, column=1).value = 'Total'
  ws_1.cell(row=song_count + 2, column=1).style = 'title_style'
  ws_1.cell(row=song_count + 2, column=len(column_names_1)).value = '=SUM({}2:{}{})'.format(
    column_letters[len(column_names_1) - 1], column_letters[len(column_names_1) - 1], song_count + 1)
  ws_1.cell(row=song_count + 2, column=len(column_names_1)).style = 'total_style'

#Sheet 3: Block,Region,Country,Income,Payee %,Rev
  #Find number of songs
  find_songs = '''SELECT Song_Name_9LC, Regional_Block_DD, Region_DD, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB
                      FROM Master GROUP BY Song_Name_9LC, Regional_Block_DD, Region_DD, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB'''
  mycursor.execute(find_songs)
  songs = [i[0] for i in mycursor.fetchall()]
  song_count = len(songs)

  #Build table
  select_table_1 = '''SELECT Song_Name_9LC, Regional_Block_DD, Region_DD, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB,  
                          sum( CASE WHEN {} >= "{}" THEN Adjusted_Royalty_SB ELSE "" END) AS `Total` FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                          GROUP BY Song_Name_9LC, Regional_Block_DD, Region_DD, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB'''.format(
    cut_off_field, cut_off)
  mycursor.execute(select_table_1)
  table_1 = mycursor.fetchall()

  #Add pool revenue line at bottom
  pool_rev_1 = '''SELECT Song_Name_9LC, Regional_Block_DD, Region_DD, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB,  
                          sum( CASE WHEN {} >= "{}" THEN Adjusted_Royalty_SB ELSE "" END) AS `Total` FROM Master WHERE Song_Name_9LC = "Pool Revenue"
                          GROUP BY Song_Name_9LC, Regional_Block_DD, Region_DD, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB'''.format(
    cut_off_field, cut_off)
  mycursor.execute(pool_rev_1)
  ...
  #Create list of column names
  column_names_1 = ['Song Title', 'Regional Block', 'Region', 'Country', 'Normalized Income Type', 'Normalized Income Type II',
                    'Payee Percent Received', 'Total Revenue']
  ...
  for song_no in range(2, song_count + 2):
    ...
    ws_2.cell(row=song_no, column=2).alignment = Alignment(horizontal="left", vertical="center")
    ws_2.cell(row=song_no, column=3).alignment = Alignment(horizontal="left", vertical="center")
  ...
  ws_2.cell(row=song_count + 2, column=1).style = 'title_style'
  ws_2.cell(row=song_count + 2, column=len(column_names_1)).value = '=SUM({}2:{}{})'.format(
    column_letters[len(column_names_1) - 1], column_letters[len(column_names_1) - 1], song_count + 1)
  ws_2.cell(row=song_count + 2, column=len(column_names_1)).style = 'total_style'

#Sheet 4: Country,Income,Song Share,Rev
  #Find number of songs
  find_songs = '''SELECT Song_Name_9LC, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB
                        FROM Master GROUP BY Song_Name_9LC, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB'''
  mycursor.execute(find_songs)
  songs = [i[0] for i in mycursor.fetchall()]
  song_count = len(songs)

  #Build table
  select_table_1 = '''SELECT Song_Name_9LC, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB,  
                            sum( CASE WHEN {} >= "{}" THEN Adjusted_Royalty_SB ELSE "" END) AS `Total` FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                            GROUP BY Song_Name_9LC, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB'''.format(
    cut_off_field, cut_off)
  mycursor.execute(select_table_1)
  table_1 = mycursor.fetchall()

  #Add pool revenue line at bottom
  pool_rev_1 = '''SELECT Song_Name_9LC, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB,  
                            sum( CASE WHEN {} >= "{}" THEN Adjusted_Royalty_SB ELSE "" END) AS `Total` FROM Master WHERE Song_Name_9LC = "Pool Revenue"
                            GROUP BY Song_Name_9LC, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB'''.format(
    cut_off_field, cut_off)
  mycursor.execute(pool_rev_1)
  ...
  #Create list of column names
  column_names_1 = ['Song Title', 'Country', 'Normalized Income Type',
                    'Normalized Income Type II',
                    'Payee Song Share', 'Total Revenue']
  ...
  for song_no in range(2, song_count + 2):
    ...
    ws_3.cell(row=song_no, column=2).alignment = Alignment(horizontal="left", vertical="center")
    ws_3.cell(row=song_no, column=3).alignment = Alignment(horizontal="left", vertical="center")
  ...
  ws_3.cell(row=song_count + 2, column=1).style = 'title_style'
  ws_3.cell(row=song_count + 2, column=len(column_names_1)).value = '=SUM({}2:{}{})'.format(
    column_letters[len(column_names_1) - 1], column_letters[len(column_names_1) - 1], song_count + 1)
  ws_3.cell(row=song_count + 2, column=len(column_names_1)).style = 'total_style'

#Sheet 5: Block,Income,Song Share,Rev
  #Find number of songs
  find_songs = '''SELECT Song_Name_9LC, Regional_Block_DD, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB
                          FROM Master GROUP BY Song_Name_9LC, Regional_Block_DD, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB'''
  mycursor.execute(find_songs)
  songs = [i[0] for i in mycursor.fetchall()]
  song_count = len(songs)

  #Build table
  select_table_1 = '''SELECT Song_Name_9LC, Regional_Block_DD, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB,  
                              sum( CASE WHEN {} >= "{}" THEN Adjusted_Royalty_SB ELSE "" END) AS `Total` FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                              GROUP BY Song_Name_9LC, Regional_Block_DD, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB'''.format(
    cut_off_field, cut_off)
  mycursor.execute(select_table_1)
  table_1 = mycursor.fetchall()

  #Add pool revenue line at bottom
  pool_rev_1 = '''SELECT Song_Name_9LC, Regional_Block_DD, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB,  
                              sum( CASE WHEN {} >= "{}" THEN Adjusted_Royalty_SB ELSE "" END) AS `Total` FROM Master WHERE Song_Name_9LC = "Pool Revenue"
                              GROUP BY Song_Name_9LC, Regional_Block_DD, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB'''.format(
    cut_off_field, cut_off)
  mycursor.execute(pool_rev_1)
  ...
  #Create list of column names
  column_names_1 = ['Song Title', 'Regional Block', 'Normalized Income Type',
                    'Normalized Income Type II',
                    'Payee Song Share', 'Total Revenue']
  ...
  for song_no in range(2, song_count + 2):
    ...
    ws_4.cell(row=song_no, column=2).alignment = Alignment(horizontal="left", vertical="center")
  ...
  ws_4.cell(row=song_count + 2, column=1).style = 'title_style'
  ws_4.cell(row=song_count + 2, column=len(column_names_1)).value = '=SUM({}2:{}{})'.format(
    column_letters[len(column_names_1) - 1], column_letters[len(column_names_1) - 1], song_count + 1)
  ws_4.cell(row=song_count + 2, column=len(column_names_1)).style = 'total_style'

#Sheet 6: Block,Region,Country,Income,Song Share,Rev
  #Find number of songs
  find_songs = '''SELECT Song_Name_9LC, Regional_Block_DD, Region_DD, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB
                            FROM Master GROUP BY Song_Name_9LC, Regional_Block_DD, Region_DD, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB'''
  mycursor.execute(find_songs)
  songs = [i[0] for i in mycursor.fetchall()]
  song_count = len(songs)

  #Build table
  select_table_1 = '''SELECT Song_Name_9LC, Regional_Block_DD, Region_DD, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB,  
                                sum( CASE WHEN {} >= "{}" THEN Adjusted_Royalty_SB ELSE "" END) AS `Total` FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                                GROUP BY Song_Name_9LC, Regional_Block_DD, Region_DD, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB'''.format(
    cut_off_field, cut_off)
  mycursor.execute(select_table_1)
  table_1 = mycursor.fetchall()

  #Add pool revenue line at bottom
  pool_rev_1 = '''SELECT Song_Name_9LC, Regional_Block_DD, Region_DD, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB,  
                                sum( CASE WHEN {} >= "{}" THEN Adjusted_Royalty_SB ELSE "" END) AS `Total` FROM Master WHERE Song_Name_9LC = "Pool Revenue"
                                GROUP BY Song_Name_9LC, Regional_Block_DD, Region_DD, Normalized_Country_9LC, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB'''.format(
    cut_off_field, cut_off)
  mycursor.execute(pool_rev_1)
  ...
  #Create list of column names
  column_names_1 = ['Song Title', 'Regional Block','Region','Country', 'Normalized Income Type',
                    'Normalized Income Type II',
                    'Payee Song Share', 'Total Revenue']
  ...
  for song_no in range(2, song_count + 2):
    ...
    ws_5.cell(row=song_no, column=2).alignment = Alignment(horizontal="left", vertical="center")
    ws_5.cell(row=song_no, column=3).alignment = Alignment(horizontal="left", vertical="center")
    ws_5.cell(row=song_no, column=4).alignment = Alignment(horizontal="left", vertical="center")
    ws_5.cell(row=song_no, column=(len(column_names_1))).number_format = '#0.00'

  #Add total row
  ws_5.cell(row=song_count + 2, column=1).value = 'Total'
  ws_5.cell(row=song_count + 2, column=1).style = 'title_style'
  ws_5.cell(row=song_count + 2, column=len(column_names_1)).value = '=SUM({}2:{}{})'.format(
    column_letters[len(column_names_1) - 1], column_letters[len(column_names_1) - 1], song_count + 1)
  ws_5.cell(row=song_count + 2, column=len(column_names_1)).style = 'total_style'
