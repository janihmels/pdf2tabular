...
def songIDISWCISRCincomepayeepercent(database, df, filename):
...
#Find number of songs
  find_songs = '''SELECT Song_Name_9LC, Payer_Song_ID_SB,SONGID_ISWC_SB, SONGID_ISRC_SB, Normalized_Income_Type_II_9LC,Income_Type_SB, Payee_Percent_Received_SB
                  FROM Master WHERE Statement_Period_Half_9LC <> "" GROUP BY Song_Name_9LC,Payer_Song_ID_SB,SONGID_ISWC_SB, SONGID_ISRC_SB, Normalized_Income_Type_II_9LC,Income_Type_SB,Payee_Percent_Received_SB'''
...
#Build sheet
  ...
  #Worksheet title
  ws.title = "Song,ID,ISWC,ISRC,Income Type,Payee %"

  #Build table
  select_table_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB,SONGID_ISWC_SB, SONGID_ISRC_SB,  Normalized_Income_Type_II_9LC, Income_Type_SB, Payee_Percent_Received_SB FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                      AND Statement_Period_Half_9LC <> "" GROUP BY Song_Name_9LC, Payer_Song_ID_SB,SONGID_ISWC_SB, SONGID_ISRC_SB, Normalized_Income_Type_II_9LC, Income_Type_SB, Payee_Percent_Received_SB'''
  mycursor.execute(select_table_1)
  table_1 = mycursor.fetchall()

  #Add pool revenue line at bottom
  pool_rev_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB,SONGID_ISWC_SB, SONGID_ISRC_SB, Normalized_Income_Type_II_9LC, Income_Type_SB, Payee_Percent_Received_SB FROM Master WHERE Song_Name_9LC = "Pool Revenue"
                      AND Statement_Period_Half_9LC <> "" GROUP BY Song_Name_9LC, Payer_Song_ID_SB,SONGID_ISWC_SB, SONGID_ISRC_SB, Normalized_Income_Type_II_9LC, Income_Type_SB, Payee_Percent_Received_SB'''
  ...
  column_names_1 = ['Song Title', 'Payer ID', 'ISWC', 'ISRC', 'Normalized Income Type II', 'Income Type', 'Payee Percent Received']
  ...
  for song_no in range(2, song_count + 2):
    ...
    ws.cell(row=song_no, column=7).alignment = Alignment(horizontal="right", vertical="center")
