...
def songIDISWCincomesongshare(database, df, filename):
...
#Find number of songs
  find_songs = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB,  Normalized_Income_Type_II_9LC,Income_Type_SB, Payee_Song_Share_SB
                  FROM Master WHERE Statement_Period_Half_9LC <> "" GROUP BY Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_II_9LC,Income_Type_SB,Payee_Song_Share_SB'''
...
#Build main pivot table
  ...
  #Worksheet title
  ws.title = "Song,ID,ISWC,Income Type,Song Share".format(period_name)

  #Build table
  select_table_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB,SONGID_ISWC_SB,  Normalized_Income_Type_II_9LC, Income_Type_SB, Payee_Song_Share_SB FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                      AND Statement_Period_Half_9LC <> "" GROUP BY Song_Name_9LC, Payer_Song_ID_SB,SONGID_ISWC_SB,   Normalized_Income_Type_II_9LC,Income_Type_SB,  Payee_Song_Share_SB'''
  ...
  pool_rev_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_II_9LC, Income_Type_SB, Payee_Song_Share_SB FROM Master WHERE Song_Name_9LC = "Pool Revenue"
                      AND Statement_Period_Half_9LC <> "" GROUP BY Song_Name_9LC, Payer_Song_ID_SB,SONGID_ISWC_SB, Normalized_Income_Type_II_9LC,Income_Type_SB, Payee_Song_Share_SB'''
  ...
  column_names_1 = ['Song Title', 'Payer ID', 'ISWC',  'Normalized Income Type II','Income Type', 'Payee Song Share']
