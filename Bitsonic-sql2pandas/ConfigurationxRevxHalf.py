...
def configurationxrevxhalf(database, df, filename):
    ...
    find_income_types = '''SELECT Normalized_Income_Type_II_9LC
    ...
    # Worksheet title
    ws.title = "Configuration x Rev x Half"
