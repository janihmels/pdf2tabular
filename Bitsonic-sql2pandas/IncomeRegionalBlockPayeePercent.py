...
def incomeregionalblockpayeepercent(database, df, filename):
...
#Build main pivot table
  ...
  #Worksheet title
  ws.title = "Song,Block,Income,Payee %"

  #Build table
  select_table_1 = '''SELECT Song_Name_9LC,Regional_Block_SB,Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC,  Payee_Percent_Received_SB FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                      AND Statement_Period_Half_9LC <> "" GROUP BY Song_Name_9LC,Regional_Block_SB,Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC,  Payee_Percent_Received_SB'''
  mycursor.execute(select_table_1)
  table_1 = mycursor.fetchall()

  #Add pool revenue line at bottom
  pool_rev_1 = '''SELECT Song_Name_9LC,Regional_Block_SB,Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC,  Payee_Percent_Received_SB FROM Master WHERE Song_Name_9LC = "Pool Revenue"
                      AND Statement_Period_Half_9LC <> "" GROUP BY Song_Name_9LC,Regional_Block_SB,Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC,  Payee_Percent_Received_SB'''
  ...
  column_names_1 = ['Song Name','Regional Block','Normalized Income Type', 'Normalized Income Type II',  'Payee Percent Received']
