...
def incomefullterritorypayeepercent(database, df, filename):
...
#Find number of songs
  find_songs = '''SELECT Song_Name_9LC,Regional_Block_SB,Region_SB,Country_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC,  Payee_Percent_Received_SB
                  FROM Master WHERE Statement_Period_Half_9LC <> "" GROUP BY Song_Name_9LC,Regional_Block_SB,Region_SB,Country_SB,Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC,Payee_Percent_Received_SB'''
...
#Build main pivot table
  ...
  #Worksheet title
  ws.title = "Song,Territory,Income,Payee %"

  #Build table
  select_table_1 = '''SELECT Song_Name_9LC,Regional_Block_SB,Region_SB,Country_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC,  Payee_Percent_Received_SB FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                      AND Statement_Period_Half_9LC <> "" GROUP BY Song_Name_9LC,Regional_Block_SB,Region_SB,Country_SB,Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB'''
  ...
  pool_rev_1 = '''SELECT Song_Name_9LC,Regional_Block_SB,Region_SB,Country_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC,  Payee_Percent_Received_SB FROM Master WHERE Song_Name_9LC = "Pool Revenue"
                      AND Statement_Period_Half_9LC <> "" GROUP BY Song_Name_9LC, Regional_Block_SB,Region_SB,Country_SB,Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB'''
  ...
  column_names_1 = ['Song Name','Regional Block','Region', 'Country','Normalized Income Type', 'Normalized Income Type II',  'Payee Percent Received']
