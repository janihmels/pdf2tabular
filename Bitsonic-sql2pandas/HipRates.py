...
def hiprates(database, df, filename):
...
#Create sheets
  ws = wb.active
  ws.title = 'Song,ID,Income,IncomeII,Song Share'
  ws_1 = wb.create_sheet(title='Song,ID,Income,Song Share')
  ws_2 = wb.create_sheet(title='Song,ID,ISWC,Income,IncomeII,Song Share')
  ws_3 = wb.create_sheet(title='Song,ID,ISWC,Income,Song Share')
  ws_4 = wb.create_sheet(title='Song,ID,Income,IncomeII,Payee %')
  ws_5 = wb.create_sheet(title='Song,ID,Income,Payee %')
  ws_6 = wb.create_sheet(title='Song,ID,ISWC,Income,IncomeII,Payee %')
  ws_7 = wb.create_sheet(title='Song,ID,ISWC,Income,Payee %')

#Sheet 1: Song,ID,Income Type,Income Type II,Song Share
  #Find number of songs
  find_songs = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB
                  FROM Master GROUP BY Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB'''
  mycursor.execute(find_songs)
  songs = [i[0] for i in mycursor.fetchall()]
  song_count = len(songs)

  #Build table
  select_table_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                      GROUP BY Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB'''
  mycursor.execute(select_table_1)
  table_1 = mycursor.fetchall()

  #Add pool revenue line at bottom
  pool_rev_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB FROM Master WHERE Song_Name_9LC = "Pool Revenue"
                      GROUP BY Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB'''
  ...
  column_names_1 = ['Song Title', 'Payer ID','Normalized Income Type',  'Normalized Income Type II', 'Payee Song Share']
  ...
  for song_no in range(2, song_count + 2):
    ...
    ws.cell(row=song_no, column=3).alignment = Alignment(horizontal="left", vertical="center")
    ws.cell(row=song_no, column=4).alignment = Alignment(horizontal="left", vertical="center")
    ws.cell(row=song_no, column=(len(column_names_1))).number_format = '#0.00'

#Sheet 2: Song,ID,Income Type,Song Share
  #Find number of songs
  find_songs = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Payee_Song_Share_SB
                  FROM Master GROUP BY Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Payee_Song_Share_SB'''
  mycursor.execute(find_songs)
  songs = [i[0] for i in mycursor.fetchall()]
  song_count = len(songs)

  #Build table
  select_table_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Payee_Song_Share_SB FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                      GROUP BY Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Payee_Song_Share_SB'''
  mycursor.execute(select_table_1)
  table_1 = mycursor.fetchall()

  #Add pool revenue line at bottom
  pool_rev_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Payee_Song_Share_SB FROM Master WHERE Song_Name_9LC = "Pool Revenue"
                      GROUP BY Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Payee_Song_Share_SB'''
  mycursor.execute(pool_rev_1)
  pool_revenue_1 = mycursor.fetchall()
  final_table_1 = table_1 + pool_revenue_1
  ...
  #Create list of column names
  column_names_1 = ['Song Title', 'Payer ID','Normalized Income Type', 'Payee Song Share']
  ...
  for song_no in range(2, song_count + 2):
    ...
    ws_1.cell(row=song_no, column=3).alignment = Alignment(horizontal="left", vertical="center")
    ws_1.cell(row=song_no, column=(len(column_names_1))).number_format = '#0.00'

#Sheet 3: Song,ID,ISWC,Income Type,Income Type II,Song Share
  #Find number of songs
  find_songs = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB
                  FROM Master GROUP BY Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB'''
  mycursor.execute(find_songs)
  songs = [i[0] for i in mycursor.fetchall()]
  song_count = len(songs)

  #Build table
  select_table_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                      GROUP BY Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB'''
  mycursor.execute(select_table_1)
  table_1 = mycursor.fetchall()

  #Add pool revenue line at bottom
  pool_rev_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB FROM Master WHERE Song_Name_9LC = "Pool Revenue"
                      GROUP BY Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Song_Share_SB'''
  mycursor.execute(pool_rev_1)
  pool_revenue_1 = mycursor.fetchall()
  final_table_1 = table_1 + pool_revenue_1
  ...
  #Create list of column names
  column_names_1 = ['Song Title', 'Payer ID','ISWC', 'Normalized Income Type','Normalized Income Type II', 'Payee Song Share']
  ...
  for (row, j) in zip(table_rows, final_table_1):
    for (cell, k) in zip(row, range(len(j))):
      ...
      cell.font = Font(name="Calibri", size="11")
  for song_no in range(2, song_count + 2):
    ws_2.cell(row=song_no, column=1).alignment = Alignment(horizontal="left", vertical="center")
    ws_2.cell(row=song_no, column=4).alignment = Alignment(horizontal="left", vertical="center")
    ws_2.cell(row=song_no, column=5).alignment = Alignment(horizontal="left", vertical="center")
    ws_2.cell(row=song_no, column=(len(column_names_1))).number_format = '#0.00'

#Sheet 4: Song,ID,ISWC,Income Type,Song Share
  #Find number of songs
  find_songs = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Payee_Song_Share_SB
                  FROM Master GROUP BY Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Payee_Song_Share_SB'''
  mycursor.execute(find_songs)
  songs = [i[0] for i in mycursor.fetchall()]
  song_count = len(songs)

  #Build table
  select_table_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Payee_Song_Share_SB FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                      GROUP BY Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Payee_Song_Share_SB'''
  mycursor.execute(select_table_1)
  table_1 = mycursor.fetchall()

  #Add pool revenue line at bottom
  pool_rev_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Payee_Song_Share_SB FROM Master WHERE Song_Name_9LC = "Pool Revenue"
                      GROUP BY Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Payee_Song_Share_SB'''
  mycursor.execute(pool_rev_1)
  pool_revenue_1 = mycursor.fetchall()
  final_table_1 = table_1 + pool_revenue_1
  ...
  #Create list of column names
  column_names_1 = ['Song Title', 'Payer ID','ISWC', 'Normalized Income Type', 'Payee Song Share']
  ...
  for (row, j) in zip(table_rows, final_table_1):
    for (cell, k) in zip(row, range(len(j))):
      ...
      cell.font = Font(name="Calibri", size="11")
  for song_no in range(2, song_count + 2):
    ws_3.cell(row=song_no, column=1).alignment = Alignment(horizontal="left", vertical="center")
    ws_3.cell(row=song_no, column=4).alignment = Alignment(horizontal="left", vertical="center")
    ws_3.cell(row=song_no, column=(len(column_names_1))).number_format = '#0.00'

#Sheet 5: Song,ID,Income Type,Income Type II,Payee %
  #Find number of songs
  find_songs = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB
                  FROM Master GROUP BY Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB'''
  mycursor.execute(find_songs)
  songs = [i[0] for i in mycursor.fetchall()]
  song_count = len(songs)

  #Build table
  select_table_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                      GROUP BY Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB'''
  mycursor.execute(select_table_1)
  table_1 = mycursor.fetchall()

  #Add pool revenue line at bottom
  pool_rev_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB FROM Master WHERE Song_Name_9LC = "Pool Revenue"
                      GROUP BY Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB'''
  mycursor.execute(pool_rev_1)
  pool_revenue_1 = mycursor.fetchall()
  final_table_1 = table_1 + pool_revenue_1
  ...
  #Create list of column names
  column_names_1 = ['Song Title', 'Payer ID', 'Normalized Income Type', 'Normalized Income Type II', 'Payee Percent Received']
  ...
  for song_no in range(2, song_count + 2):
    ...
    ws_4.cell(row=song_no, column=3).alignment = Alignment(horizontal="left", vertical="center")
    ws_4.cell(row=song_no, column=4).alignment = Alignment(horizontal="left", vertical="center")
    ws_4.cell(row=song_no, column=(len(column_names_1))).number_format = '#0.00'

#Sheet 6: Song,ID,Income Type,Payee %
  #Find number of songs
  find_songs = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Payee_Percent_Received_SB
                  FROM Master GROUP BY Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Payee_Percent_Received_SB'''
  mycursor.execute(find_songs)
  songs = [i[0] for i in mycursor.fetchall()]
  song_count = len(songs)

  #Build table
  select_table_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Payee_Percent_Received_SB FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                      GROUP BY Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Payee_Percent_Received_SB'''
  mycursor.execute(select_table_1)
  table_1 = mycursor.fetchall()

  #Add pool revenue line at bottom
  pool_rev_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Payee_Percent_Received_SB FROM Master WHERE Song_Name_9LC = "Pool Revenue"
                      GROUP BY Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_9LC, Payee_Percent_Received_SB'''
  mycursor.execute(pool_rev_1)
  pool_revenue_1 = mycursor.fetchall()
  final_table_1 = table_1 + pool_revenue_1
  ...
  #Create list of column names
  column_names_1 = ['Song Title', 'Payer ID', 'Normalized Income Type', 'Payee Percent Received']
  ...
  for (row, j) in zip(table_rows, final_table_1):
    for (cell, k) in zip(row, range(len(j))):
      ...
      cell.font = Font(name="Calibri", size="11")
  for song_no in range(2, song_count + 2):
    ws_5.cell(row=song_no, column=1).alignment = Alignment(horizontal="left", vertical="center")
    ws_5.cell(row=song_no, column=3).alignment = Alignment(horizontal="left", vertical="center")
    ws_5.cell(row=song_no, column=(len(column_names_1))).number_format = '#0.00'

#Sheet 7: Song,ID,ISWC,Income Type,Income Type II,Payee %
  #Find number of songs
  find_songs = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB
                  FROM Master GROUP BY Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB'''
  mycursor.execute(find_songs)
  songs = [i[0] for i in mycursor.fetchall()]
  song_count = len(songs)

  #Build table
  select_table_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                      GROUP BY Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB'''
  mycursor.execute(select_table_1)
  table_1 = mycursor.fetchall()

  #Add pool revenue line at bottom
  pool_rev_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB FROM Master WHERE Song_Name_9LC = "Pool Revenue"
                      GROUP BY Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Normalized_Income_Type_II_9LC, Payee_Percent_Received_SB'''
  mycursor.execute(pool_rev_1)
  pool_revenue_1 = mycursor.fetchall()
  final_table_1 = table_1 + pool_revenue_1
  ...
  #Create list of column names
  column_names_1 = ['Song Title', 'Payer ID','ISWC', 'Normalized Income Type','Normalized Income Type II', 'Payee Percent Received']
  ...
  for (row, j) in zip(table_rows, final_table_1):
    for (cell, k) in zip(row, range(len(j))):
      ...
      cell.font = Font(name="Calibri", size="11")
  for song_no in range(2, song_count + 2):
    ws_6.cell(row=song_no, column=1).alignment = Alignment(horizontal="left", vertical="center")
    ws_6.cell(row=song_no, column=4).alignment = Alignment(horizontal="left", vertical="center")
    ws_6.cell(row=song_no, column=5).alignment = Alignment(horizontal="left", vertical="center")
    ws_6.cell(row=song_no, column=(len(column_names_1))).number_format = '#0.00'

#Sheet 8: Song,ID,ISWC,Income Type,Payee %
  #Find number of songs
  find_songs = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Payee_Percent_Received_SB
                  FROM Master GROUP BY Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Payee_Percent_Received_SB'''
  mycursor.execute(find_songs)
  songs = [i[0] for i in mycursor.fetchall()]
  song_count = len(songs)

  #Build table
  select_table_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Payee_Percent_Received_SB FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                      GROUP BY Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Payee_Percent_Received_SB'''
  mycursor.execute(select_table_1)
  table_1 = mycursor.fetchall()

  #Add pool revenue line at bottom
  pool_rev_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Payee_Percent_Received_SB FROM Master WHERE Song_Name_9LC = "Pool Revenue"
                      GROUP BY Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, Normalized_Income_Type_9LC, Payee_Percent_Received_SB'''
  mycursor.execute(pool_rev_1)
  pool_revenue_1 = mycursor.fetchall()
  final_table_1 = table_1 + pool_revenue_1
  ...
  #Create list of column names
  column_names_1 = ['Song Title', 'Payer ID','ISWC', 'Normalized Income Type', 'Payee Percent Received']
  ...
  for (row, j) in zip(table_rows, final_table_1):
    for (cell, k) in zip(row, range(len(j))):
      ...
      cell.font = Font(name="Calibri", size="11")
  for song_no in range(2, song_count + 2):
    ws_7.cell(row=song_no, column=1).alignment = Alignment(horizontal="left", vertical="center")
    ws_7.cell(row=song_no, column=4).alignment = Alignment(horizontal="left", vertical="center")
    ws_7.cell(row=song_no, column=(len(column_names_1))).number_format = '#0.00'
