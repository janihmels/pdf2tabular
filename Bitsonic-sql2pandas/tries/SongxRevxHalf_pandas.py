...
def songxrevxhalf(database: str,
                  df: pd.DataFrame,
                  filename: str):
    ...
    third_party_list = list(df['Third_Party_9LC'].drop_duplicates())
    ...
    rights_type_list = list(df['Rights_Type_9LC'].drop_duplicates())
    rights_type_list.remove('')
    ...
    recent_years = list(df['Year_Statement_9LC'].drop_duplicates())
    ...
    statement_period_half_blank = sorted(list(df['Statement_Period_Half_9LC'][df['Year_Statement_9LC'].astype(int) <= find_cut_off_year].drop_duplicates()))
    ...
    complete_list = [(x, ) for x in list(df['Year_Statement_9LC'][df['Year_Statement_9LC'] >= year_cut_off].drop_duplicates())]
    ...
    complete_list = df[['Year_Statement_9LC', 'Half_Statement_9LC']][(df['Half_Statement_9LC'] != '') & (df['Statement_Period_Half_9LC'] >= standard_cut_off)].drop_duplicates()
    complete_list = [(x, y) for x, y in zip(complete_list['Year_Statement_9LC'], complete_list['Half_Statement_9LC'])]
    ...
    complete_list = df[['Year_Statement_9LC', 'Quarter_Statement_9LC']][(df['Quarter_Statement_9LC'] != '') & (df['Statement_Period_Half_9LC'] >= standard_cut_off)].drop_duplicates()
    complete_list = [(x, y) for x, y in zip(complete_list['Year_Statement_9LC'], complete_list['Quarter_Statement_9LC'])]
    ...
    complete_list = df[['Year_Statement_9LC', 'Month_Statement_9LC']][
        (df['Month_Statement_9LC'] != '') & (df['Statement_Period_Half_9LC'] >= standard_cut_off)].drop_duplicates()
    complete_list = [(x, y) for x, y in
                     zip(complete_list['Year_Statement_9LC'], complete_list['Month_Statement_9LC'])]
    ...
    for b in third_party_list:
        ...
        complete_year = list(df['Statement_Period_Half_9LC'][df['Year_Statement_9LC'].astype(int) == test_year].drop_duplicates())
    ...
    a = df[['Rights_Type_9LC', 'Third_Party_9LC']].drop_duplicates()
    type_list = list(dict.fromkeys(a['Rights_Type_9LC']))
    test = list(a['Third_Party_9LC'])
    ...
    for a in type_list:
        ...
        test_list = list(df['Third_Party_9LC'][df['Rights_Type_9LC'] == a].drop_duplicates())
    ...
    for b in type_list:
        ...
        third_parties = list(df['Third_Party_9LC'][df['Rights_Type_9LC'] == b])
        ...
        quarterly_third_parties = list(df['Third_Party_9LC'][(df['Rights_Type_9LC'] == b) & (df['Quarter_Statement_9LC'] != '')])
    ...
    for b in type_list:
        ...
        half_third_parties = list(df['Third_Party_9LC'][(df['Rights_Type_9LC'] == b) & (df['Half_Statement_9LC'] != '')])
    ...
    songs = list(df[['Song_Name_9LC', 'Release_Date_9LC']].drop_duplicates()['Song_Name_9LC'])
    ...
    year_column_names = ['Song Title', 'Release Date']
    ...
    half_column_names = ['Song Title', 'Release Date']
    ...
    quarter_column_names = ['Song Title', 'Release Date']
    ...
    for s in third_party_type_list:
        ...
        select_table_1 = '''SELECT Song_Name_9LC, Release_Date_9LC,'''
        select_table_2 = ""
        ...
        select_table_3 = '''sum( CASE WHEN Song_Name_9LC <> "Pool Revenue" AND {} >= "{}"
                         THEN Adjusted_Royalty_SB ELSE "" END) AS `Total`
                         FROM Master WHERE Song_Name_9LC <> "Pool Revenue" 
                         AND Rights_Type_9LC = "{}"
                         GROUP BY Song_Name_9LC, Release_Date_9LC ORDER BY `Total` DESC'''.format(cut_off_field,
                                                                                                  cut_off, s[0])
        select_table = select_table_1 + select_table_2 + select_table_3
        mycursor.execute(select_table)
        table = mycursor.fetchall()

        # Add pool revenue line at bottom (song x rev x half)
        pool_rev_1 = '''SELECT Song_Name_9LC, Release_Date_9LC,'''
        pool_rev_2 = ""
        for l, m in zip(year_statement_list, statement_list):
            pool_rev_2 += ('''sum( CASE WHEN Year_Statement_9LC = "{}" AND {} = "{}" 
                            AND Song_Name_9LC = "Pool Revenue"
                            THEN Adjusted_Royalty_SB ELSE "" END) AS `{} {}`,'''.format(l, mySQL_column, m, l, m))
        pool_rev_3 = '''sum( CASE WHEN Song_Name_9LC = "Pool Revenue" AND {} >= "{}"
                      THEN Adjusted_Royalty_SB ELSE "" END) AS `Total` 
                      FROM Master WHERE Song_Name_9LC = "Pool Revenue"
                      AND Rights_Type_9LC = "{}"
        ...
        for (l, m) in zip(range(2, len(column_names) - 1), column_letters_2):
            ws.cell(row=total_row_no + 1, column=l).value = "=SUM({}{}:{}{})".format(m, header_row_no + 1, m,
                                                                                     total_row_no)
        ...
        ws.cell(row=header_row_no + 2, column=len(column_names)).value = "=({}{})".format(percent_rev_column_letter,
                                                                                          header_row_no + 2)
    ...
    for a in third_party_list:
        ...
        full_list_months = df[['Statement_Period_9LC', 'Month_Statement_9LC']][df['Third_Party_9LC'] == a].drop_duplicates()
        statement_number_blanks = list(full_list_months['Statement_Period_9LC'])
        statement_number_months_blanks = list(full_list_months['Month_Statement_9LC'])
        ...
        months_test = list(df['Month_Statement_9LC'][(df['Month_Statement_9LC'] != '') & (df['Third_Party_9LC'] == a)].drop_duplicates())
        ...
        full_list_quarters = df[['Statement_Period_9LC', 'Quarter_Statement_9LC']][df['Third_Party_9LC'] == a].drop_duplicates()
        statement_number_blanks = list(df['Statement_Period_9LC'])
        statement_number_quarters_blanks = list(df['Quarter_Statement_9LC'])
        ...
        quarters_test = list(df['Quarter_Statement_9LC'][(df['Quarter_Statement_9LC'] != '') & (df['Year_Statement_9LC'] == base_year_value) & (df['Third_Party_9LC'] == a)].drop_duplicates())
        ...
        full_list_halves = df[['Statement_Period_9LC', 'Half_Statement_9LC']][df['Third_Party_9LC'] == a].drop_duplicates()
        statement_number_blanks = list(full_list_halves['Statement_Period_9LC'])
        statement_number_halves_blanks = list(full_list_halves['Half_Statement_9LC'])
...
if __name__ == "__main__":
    # df = pd.read_parquet('./master.parquet.gz')

    with open('sample_df.pkl', 'rb') as f:
        df = pickle.load(f)

    songxrevxhalf('Adman Khan_61b775f7c94b68a289900e81', df, None)
