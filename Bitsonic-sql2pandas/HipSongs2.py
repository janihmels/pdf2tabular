...
def hipsongs2(database, df, filename):
...
#Create sheets
  ws = wb.active
  ws.title = 'Song'
  ws_1 = wb.create_sheet(title='Song,ID')
  ws_2 = wb.create_sheet(title='Song,ISWC')
  ws_3 = wb.create_sheet(title='Song,ISWC,ISRC')
  ws_4 = wb.create_sheet(title='Song,ID,ISWC,ISRC')
  ws_5 = wb.create_sheet(title='Song,Artist,ID,ISWC,ISRC')
...
#Sheet 1: Song x Rev x Half
  ...
  select_table_1_3 = '''sum( CASE WHEN Song_Name_9LC <> "Pool Revenue" AND {} >= "{}"
                     ...
                     GROUP BY Song_Name_9LC ORDER BY `Total` DESC'''.format(cut_off_field, cut_off)
  ...
  for j, k in zip(range(2, song_count + 2), table_1):
...
#Sheet 2: Song,ID x Rev x Half
  #Song count
  find_songs = '''SELECT Song_Name_9LC, Payer_Song_ID_SB
                    FROM Master GROUP BY Song_Name_9LC, Payer_Song_ID_SB'''
  mycursor.execute(find_songs)
  songs = [i[0] for i in mycursor.fetchall()]
  song_count = len(songs)

  #Build table
  select_table_1_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB,'''
  select_table_1_2 = ""
  for j, k in zip(year_statement_list, statement_list):
    select_table_1_2 += (''' sum( CASE WHEN Year_Statement_9LC = "{}" AND {} = "{}" AND Song_Name_9LC <> "Pool Revenue" 
                             THEN Adjusted_Royalty_SB ELSE "" END) AS `{} {}`,'''.format(j, mySQL_column, k, j, k))
  select_table_1_3 = '''sum( CASE WHEN Song_Name_9LC <> "Pool Revenue" AND {} >= "{}"
                     THEN Adjusted_Royalty_SB ELSE "" END) AS `Total`
                     FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                     GROUP BY Song_Name_9LC, Payer_Song_ID_SB ORDER BY `Total` DESC'''.format(cut_off_field, cut_off)
  select_table_1 = select_table_1_1 + select_table_1_2 + select_table_1_3
  mycursor.execute(select_table_1)
  table_1 = mycursor.fetchall()

  #Add pool revenue line at bottom
  pool_rev_1_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB,'''
  pool_rev_1_2 = ""
  for l, m in zip(year_statement_list, statement_list):
    pool_rev_1_2 += ('''sum( CASE WHEN Year_Statement_9LC = "{}" AND {} = "{}" AND Song_Name_9LC = "Pool Revenue"
                        THEN Adjusted_Royalty_SB ELSE "" END) AS `{} {}`,'''.format(l, mySQL_column, m, l, m))
  ...
  #Column names
  column_names_1 = ['Song Title', 'Payer ID']
  for k in statement_period_list:
    column_names_1.append(k)
  column_names_1.append('Total')
  column_names_1.append('% Of Revenue')
...
#Sheet 3: Song,Date,ISWC x Rev x Half
  #Song count
  find_songs = '''SELECT Song_Name_9LC,SONGID_ISWC_SB
                    FROM Master GROUP BY Song_Name_9LC,SONGID_ISWC_SB'''
  mycursor.execute(find_songs)
  songs = [i[0] for i in mycursor.fetchall()]
  song_count = len(songs)

  #Build table
  select_table_1_1 = '''SELECT Song_Name_9LC,SONGID_ISWC_SB,'''
  select_table_1_2 = ""
  for j, k in zip(year_statement_list, statement_list):
    select_table_1_2 += (''' sum( CASE WHEN Year_Statement_9LC = "{}" AND {} = "{}" AND Song_Name_9LC <> "Pool Revenue" 
                             THEN Adjusted_Royalty_SB ELSE "" END) AS `{} {}`,'''.format(j, mySQL_column, k, j, k))
  select_table_1_3 = '''sum( CASE WHEN Song_Name_9LC <> "Pool Revenue" AND {} >= "{}"
                     THEN Adjusted_Royalty_SB ELSE "" END) AS `Total`
                     FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                     GROUP BY Song_Name_9LC,SONGID_ISWC_SB ORDER BY `Total` DESC'''.format(cut_off_field, cut_off)
  select_table_1 = select_table_1_1 + select_table_1_2 + select_table_1_3
  mycursor.execute(select_table_1)
  table_1 = mycursor.fetchall()

  #Add pool revenue line at bottom
  pool_rev_1_1 = '''SELECT Song_Name_9LC,SONGID_ISWC_SB,'''
  pool_rev_1_2 = ""
  for l, m in zip(year_statement_list, statement_list):
    pool_rev_1_2 += ('''sum( CASE WHEN Year_Statement_9LC = "{}" AND {} = "{}" AND Song_Name_9LC = "Pool Revenue"
                        THEN Adjusted_Royalty_SB ELSE "" END) AS `{} {}`,'''.format(l, mySQL_column, m, l, m))
  ...
  #Column names
  column_names_1 = ['Song Title','ISWC']
  for k in statement_period_list:
    column_names_1.append(k)
  column_names_1.append('Total')
  column_names_1.append('% Of Revenue')
...
#Sheet 4: Song,Date,ISWC,ISRC x Rev x Half
  ...
  find_songs = '''SELECT Song_Name_9LC,SONGID_ISWC_SB, SONGID_ISRC_SB
                    FROM Master GROUP BY Song_Name_9LC,SONGID_ISWC_SB, SONGID_ISRC_SB'''
  mycursor.execute(find_songs)
  songs = [i[0] for i in mycursor.fetchall()]
  song_count = len(songs)

  #Build table
  select_table_1_1 = '''SELECT Song_Name_9LC, SONGID_ISWC_SB, SONGID_ISRC_SB,'''
  select_table_1_2 = ""
  for j, k in zip(year_statement_list, statement_list):
    select_table_1_2 += (''' sum( CASE WHEN Year_Statement_9LC = "{}" AND {} = "{}" AND Song_Name_9LC <> "Pool Revenue" 
                             THEN Adjusted_Royalty_SB ELSE "" END) AS `{} {}`,'''.format(j, mySQL_column, k, j, k))
  select_table_1_3 = '''sum( CASE WHEN Song_Name_9LC <> "Pool Revenue" AND {} >= "{}"
                     THEN Adjusted_Royalty_SB ELSE "" END) AS `Total`
                     FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                     GROUP BY Song_Name_9LC,SONGID_ISWC_SB, SONGID_ISRC_SB ORDER BY `Total` DESC'''.format(
  ...
  #Add pool revenue line at bottom
  pool_rev_1_1 = '''SELECT Song_Name_9LC, SONGID_ISWC_SB, SONGID_ISRC_SB,'''
  pool_rev_1_2 = ""
  for l, m in zip(year_statement_list, statement_list):
    pool_rev_1_2 += ('''sum( CASE WHEN Year_Statement_9LC = "{}" AND {} = "{}" AND Song_Name_9LC = "Pool Revenue"
                        THEN Adjusted_Royalty_SB ELSE "" END) AS `{} {}`,'''.format(l, mySQL_column, m, l, m))
  ...
  #Column names
  column_names_1 = ['Song Title','ISWC', 'ISRC']
  for k in statement_period_list:
    column_names_1.append(k)
  column_names_1.append('Total')
  column_names_1.append('% Of Revenue')
...
#Sheet 5: Song,Date,ID,ISWC,ISRC x Rev x Half
  ...
  #Build table
  select_table_1_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, SONGID_ISRC_SB,'''
  select_table_1_2 = ""
  for j, k in zip(year_statement_list, statement_list):
    select_table_1_2 += (''' sum( CASE WHEN Year_Statement_9LC = "{}" AND {} = "{}" AND Song_Name_9LC <> "Pool Revenue" 
                             THEN Adjusted_Royalty_SB ELSE "" END) AS `{} {}`,'''.format(j, mySQL_column, k, j, k))
  select_table_1_3 = '''sum( CASE WHEN Song_Name_9LC <> "Pool Revenue" AND {} >= "{}"
                     THEN Adjusted_Royalty_SB ELSE "" END) AS `Total`
                     FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                     GROUP BY Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, SONGID_ISRC_SB ORDER BY `Total` DESC'''.format(
    cut_off_field, cut_off)
  select_table_1 = select_table_1_1 + select_table_1_2 + select_table_1_3
  mycursor.execute(select_table_1)
  table_1 = mycursor.fetchall()
  ...
  #Add pool revenue line at bottom
  pool_rev_1_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, SONGID_ISRC_SB,'''
  pool_rev_1_2 = ""
  for l, m in zip(year_statement_list, statement_list):
    pool_rev_1_2 += ('''sum( CASE WHEN Year_Statement_9LC = "{}" AND {} = "{}" AND Song_Name_9LC = "Pool Revenue"
                        THEN Adjusted_Royalty_SB ELSE "" END) AS `{} {}`,'''.format(l, mySQL_column, m, l, m))
  ...
  #Column names
  column_names_1 = ['Song Title', 'Payer ID', 'ISWC', 'ISRC']
  for k in statement_period_list:
    column_names_1.append(k)
  column_names_1.append('Total')
  column_names_1.append('% Of Revenue')
...
#Sheet 6: Song,Date,Artist,ID,ISWC,ISRC x Rev x Half
  #Song count
  find_songs = '''SELECT Song_Name_9LC,Release_Artist_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, SONGID_ISRC_SB
                    FROM Master GROUP BY Song_Name_9LC, Release_Artist_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, SONGID_ISRC_SB'''
  mycursor.execute(find_songs)
  songs = [i[0] for i in mycursor.fetchall()]
  song_count = len(songs)

  #Build table
  select_table_1_1 = '''SELECT Song_Name_9LC,Release_Artist_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, SONGID_ISRC_SB,'''
  select_table_1_2 = ""
  for j, k in zip(year_statement_list, statement_list):
    select_table_1_2 += (''' sum( CASE WHEN Year_Statement_9LC = "{}" AND {} = "{}" AND Song_Name_9LC <> "Pool Revenue" 
                             THEN Adjusted_Royalty_SB ELSE "" END) AS `{} {}`,'''.format(j, mySQL_column, k, j, k))
  select_table_1_3 = '''sum( CASE WHEN Song_Name_9LC <> "Pool Revenue" AND {} >= "{}"
                     THEN Adjusted_Royalty_SB ELSE "" END) AS `Total`
                     FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                     GROUP BY Song_Name_9LC, Release_Artist_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, SONGID_ISRC_SB ORDER BY `Total` DESC'''.format(
    cut_off_field, cut_off)
  select_table_1 = select_table_1_1 + select_table_1_2 + select_table_1_3
  mycursor.execute(select_table_1)
  table_1 = mycursor.fetchall()
  ...
  #Add pool revenue line at bottom
  pool_rev_1_1 = '''SELECT Song_Name_9LC, Release_Artist_9LC, Payer_Song_ID_SB, SONGID_ISWC_SB, SONGID_ISRC_SB,'''
  pool_rev_1_2 = ""
  for l, m in zip(year_statement_list, statement_list):
    pool_rev_1_2 += ('''sum( CASE WHEN Year_Statement_9LC = "{}" AND {} = "{}" AND Song_Name_9LC = "Pool Revenue"
                        THEN Adjusted_Royalty_SB ELSE "" END) AS `{} {}`,'''.format(l, mySQL_column, m, l, m))
  ...
  #Column names
  column_names_1 = ['Song Title','Release Artist', 'Payer ID', 'ISWC', 'ISRC']
  for k in statement_period_list:
    column_names_1.append(k)
  column_names_1.append('Total')
  column_names_1.append('% Of Revenue')
  ...
  for income_no in range(2, song_count + 2):
    ...
    ws_5.cell(row=income_no, column=2).alignment = Alignment(horizontal="left", vertical="center")
...
#Sheet 7: Artist x Rev x Half
  ...
  for income_no in range(2, song_count + 2):
    ...
    ws_6.cell(row=income_no, column=3).alignment = Alignment(horizontal="left", vertical="center")
