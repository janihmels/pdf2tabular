...
def songIDincomesongshare(database, df, filename):
...
#Find number of songs
  find_songs = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_II_9LC, Income_Type_SB, Payee_Song_Share_SB
                  FROM Master WHERE Statement_Period_Half_9LC <> "" GROUP BY Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_II_9LC, Income_Type_SB,Payee_Song_Share_SB'''
...
#Build sheet
  ...
  #Worksheet title
  ws.title = "Song,ID,Income Type,Song Share".format(period_name)

  #Build table
  select_table_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_II_9LC, Income_Type_SB, Payee_Song_Share_SB FROM Master WHERE Song_Name_9LC <> "Pool Revenue"
                      AND Statement_Period_Half_9LC <> "" GROUP BY Song_Name_9LC, Payer_Song_ID_SB,  Normalized_Income_Type_II_9LC,Income_Type_SB, Payee_Song_Share_SB'''
  mycursor.execute(select_table_1)
  table_1 = mycursor.fetchall()

  #Add pool revenue line at bottom
  pool_rev_1 = '''SELECT Song_Name_9LC, Payer_Song_ID_SB, Normalized_Income_Type_II_9LC, Income_Type_SB, Payee_Song_Share_SB FROM Master WHERE Song_Name_9LC = "Pool Revenue"
                      AND Statement_Period_Half_9LC <> "" GROUP BY Song_Name_9LC, Payer_Song_ID_SB,  Normalized_Income_Type_II_9LC,Income_Type_SB, Payee_Song_Share_SB'''
  ...
  column_names_1 = ['Song Title', 'Payer ID',  'Normalized Income Type II','Income Type', 'Payee Song Share']
